...
const services = [
  { icon: '🍎', title: 'ARKit (iOS) Development', desc: 'Native ARKit integration for iPhone and iPad — LiDAR scanning, plane detection, face tracking, and world tracking for high-fidelity iOS AR experiences.' },
  { icon: '🤖', title: 'ARCore (Android) Development', desc: 'Full ARCore implementation on Android — motion tracking, environmental understanding, and light estimation for immersive Android AR apps.' },
  { icon: '🎯', title: 'Marker-Based AR', desc: 'Image and QR code triggered AR overlays. Perfect for packaging, print media, retail displays, and educational materials that spring to life.' },
  { icon: '🌐', title: 'Markerless / Surface AR', desc: 'AR that anchors to real-world surfaces without markers. Furniture placement, interior design preview, and spatial interaction powered by plane detection.' },
  { icon: '👗', title: 'AR Try-On Experiences', desc: 'Virtual try-on for eyewear, clothing, accessories, and cosmetics. Increase conversion and reduce returns with photorealistic AR product visualisation.' },
  { icon: '📍', title: 'Location-Based AR', desc: 'GPS-anchored AR experiences for outdoor navigation, tourism, city-scale art installations, and hyperlocal marketing activations.' },
];
...
const steps = [
  ...
  { num: '02', title: 'Environment Mapping', desc: 'Our team analyses target environments, lighting conditions, and device constraints to design an AR architecture that performs reliably in the real world.' },
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Modern ARKit and ARCore surface detection is remarkably accurate — typically within 1–2cm on well-lit, textured surfaces. LiDAR-equipped iPhones achieve near-instant, millimetre-level accuracy. Performance degrades on reflective, uniformly coloured, or poorly lit surfaces. We design experiences with these constraints in mind and implement fallback interactions for challenging environments.',
  },
  {
    ...
    <>
      ...
      <main style={{ background: '#ffffff', color: '#111827', fontFamily: 'inherit' }}>
        ...
        <section ref={heroRef} style={{ minHeight: '60vh', display: 'flex', alignItems: 'center', paddingTop: 140, paddingBottom: 80, background: 'radial-gradient(ellipse 80% 60% at 50% -10%, rgba(79,70,229,0.12) 0%, transparent 70%)' }}>
          <div className="cb-container">
            ...
            <div className="reveal" style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 28, fontSize: 12, color: 'rgba(0,0,0,0.4)' }}>
              ...
              <span>/</span>
              <span style={{ color: '#4F46E5' }}>Mobile AR Development</span>
            </div>
            <div className="reveal reveal-d1" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '6px 16px', borderRadius: 100, background: 'rgba(79,70,229,0.08)', border: '1px solid rgba(79,70,229,0.2)', marginBottom: 24 }}>
              ...
              <span style={{ fontSize: 12, fontWeight: 600, color: '#4F46E5', letterSpacing: '0.05em' }}>AR &amp; VR DEVELOPMENT</span>
            </div>
            <h1 className="reveal reveal-d2" style={{ fontSize: 'clamp(36px, 6vw, 72px)', fontWeight: 800, letterSpacing: '-0.04em', lineHeight: 1.05, marginBottom: 24, maxWidth: 800 }}>
              Mobile AR with <span style={{ color: '#4F46E5' }}>ARKit &amp; ARCore</span>
            </h1>
            <p className="reveal reveal-d3" style={{ fontSize: 18, color: 'rgba(0,0,0,0.45)', lineHeight: 1.7, maxWidth: 600, marginBottom: 40 }}>We build native iOS and Android augmented reality experiences — from try-on to location-based AR — using the latest ARKit and ARCore capabilities.</p>
        ...
        <section ref={s4} style={{ padding: '120px 0', textAlign: 'center', background: 'radial-gradient(ellipse 60% 60% at 50% 50%, rgba(79,70,229,0.08) 0%, transparent 70%)' }}>
          <div className="cb-container">
            <h2 className="reveal" style={{ fontSize: 'clamp(32px, 5vw, 60px)', fontWeight: 800, letterSpacing: '-0.04em', marginBottom: 20 }}>Ready to Build Your AR App?</h2>
