...
const services = [
  { icon: '🎯', title: 'Unreal Engine 5 Development', desc: 'Full-cycle UE5 game development — project setup, gameplay programming in Blueprint and C++, level design, content integration, and platform optimisation for PC, console, and VR.' },
...
const steps = [
  ...
  { num: '04', title: 'Optimisation & Shipping', desc: 'Unreal Insights profiling, PSO caching, shader compilation optimisation, and platform-specific packaging. We handle console certification submissions and Steam Deck verification.' },
];
        ...
        <section ref={heroRef} style={{ minHeight: '60vh', display: 'flex', alignItems: 'center', paddingTop: 140, paddingBottom: 80, position: 'relative', overflow: 'hidden' }}>
          ...
          <div className="cb-container">
            ...
            <div className="reveal" style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 28, fontSize: 12, color: 'rgba(0,0,0,0.4)' }}>
              ...
              <span>/</span>
              <span style={{ color: '#111827' }}>Unreal Engine Development</span>
            </div>
            ...
            <h1 className="reveal reveal-d2" style={{ fontSize: 'clamp(36px, 6vw, 72px)', fontWeight: 800, letterSpacing: '-0.04em', lineHeight: 1.05, marginBottom: 24, maxWidth: 800 }}>
              Unreal Engine 5 with <span style={{ color: '#111827' }}>AAA Visuals</span>
            </h1>
            <p className="reveal reveal-d3" style={{ fontSize: 18, color: 'rgba(0,0,0,0.45)', lineHeight: 1.7, maxWidth: 600, marginBottom: 40 }}>We build cinematic-quality games, simulations, and visualisations in Unreal Engine 5 — leveraging Lumen, Nanite, and Chaos to deliver experiences that redefine what real-time looks like.</p>
