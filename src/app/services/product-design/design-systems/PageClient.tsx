...
const services = [
  { icon: '🧩', title: 'Component Library Design', desc: 'A comprehensive set of reusable UI components with all states, variants, and responsive behaviours documented and ready to implement.' },
  { icon: '🎨', title: 'Design Token Architecture', desc: 'Semantic design tokens for colour, spacing, typography, and elevation — creating a single source of truth for design and code.' },
  { icon: '📐', title: 'Figma Component Library', desc: 'A fully organised Figma library with auto-layout components, variants, and interactive states that mirror your production component library.' },
  { icon: '📖', title: 'Storybook Documentation', desc: 'Interactive component documentation in Storybook so engineers can browse, test, and integrate components without guesswork.' },
  { icon: '♿', title: 'Accessibility Standards (WCAG 2.1)', desc: 'Every component built to WCAG 2.1 AA standards with colour contrast ratios, keyboard navigation, ARIA labels, and focus management.' },
  { icon: '🏛️', title: 'Design System Governance', desc: 'Contribution guidelines, versioning strategy, and governance processes so your system stays consistent as teams and products grow.' },
];
        ...
        <section ref={heroRef} style={{ minHeight: '60vh', display: 'flex', alignItems: 'center', paddingTop: 140, paddingBottom: 80, background: 'radial-gradient(ellipse 80% 60% at 50% -10%, rgba(79,70,229,0.12) 0%, transparent 70%)' }}>
          <div className="cb-container">
            ...
            <div className="reveal" style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 28, fontSize: 12, color: 'rgba(0,0,0,0.4)' }}>
              ...
              <span>/</span>
              <Link href="/services/product-design" style={{ color: 'rgba(0,0,0,0.4)', textDecoration: 'none' }}>Product Design</Link>
              <span>/</span>
              <span style={{ color: '#4F46E5' }}>Design Systems</span>
            </div>
            <div className="reveal reveal-d1" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '6px 16px', borderRadius: 100, background: 'rgba(79,70,229,0.08)', border: '1px solid rgba(79,70,229,0.2)', marginBottom: 24 }}>
              ...
              <span style={{ fontSize: 12, fontWeight: 600, color: '#4F46E5', letterSpacing: '0.05em' }}>PRODUCT DESIGN</span>
            </div>
            <h1 className="reveal reveal-d2" style={{ fontSize: 'clamp(36px, 6vw, 72px)', fontWeight: 800, letterSpacing: '-0.04em', lineHeight: 1.05, marginBottom: 24, maxWidth: 800 }}>
              Design Systems That <span style={{ color: '#4F46E5' }}>Scale Teams</span>
            </h1>
            <p className="reveal reveal-d3" style={{ fontSize: 18, color: 'rgba(0,0,0,0.45)', lineHeight: 1.7, maxWidth: 600, marginBottom: 40 }}>We build the single source of truth your design and engineering teams need to ship consistently, accessibly, and at speed.</p>
