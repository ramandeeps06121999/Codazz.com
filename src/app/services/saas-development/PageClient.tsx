      ...
      <main style={{ background: '#ffffff', color: '#111827', paddingTop: 80 }}>
        ...
        <section ref={s2} className="section-padding" style={{ borderBottom: '1px solid rgba(0,0,0,0.05)' }}>
          <div className="cb-container">
            ...
            <p className="reveal reveal-d2" style={{ fontSize: 16, color: 'rgba(0,0,0,0.45)', maxWidth: 520, margin: '0 0 56px', lineHeight: 1.7 }}>End-to-end SaaS development from concept to scale.</p>
            {/* Service Cards */}
