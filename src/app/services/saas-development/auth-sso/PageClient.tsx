...
const services = [
  ...
  { icon: '🛡️', title: 'Multi-Factor Authentication', desc: 'TOTP-based MFA (Google Authenticator, Authy), SMS fallback, backup codes, and MFA enforcement policies per organisation — critical for enterprise deals.' },
        ...
        <section ref={heroRef} style={{ minHeight: '60vh', display: 'flex', alignItems: 'center', paddingTop: 140, paddingBottom: 80, position: 'relative', overflow: 'hidden' }}>
          ...
          <div className="cb-container">
            ...
            <div className="reveal" style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 28, fontSize: 12, color: 'rgba(255,255,255,0.4)' }}>
              ...
              <span>/</span>
              <span style={{ color: '#ffffff' }}>Authentication & SSO</span>
            </div>
            ...
            <h1 className="reveal reveal-d2" style={{ fontSize: 'clamp(36px, 6vw, 72px)', fontWeight: 800, letterSpacing: '-0.04em', lineHeight: 1.05, marginBottom: 24, maxWidth: 800 }}>
              SaaS Authentication <span style={{ color: '#ffffff' }}>& SSO</span>
            </h1>
            <p className="reveal reveal-d3" style={{ fontSize: 18, color: 'rgba(255,255,255,0.45)', lineHeight: 1.7, maxWidth: 600, marginBottom: 40 }}>Secure auth infrastructure that scales from consumer to enterprise — SAML SSO, MFA, RBAC and audit logs that win you deals and pass security reviews.</p>
