...
const pageData: ServicePageData = {
  ...
  faqs: [
    ...
    { q: 'How much does a generative AI project cost?', a: 'Costs range from $25,000 for a focused chatbot or content generation tool to $150,000+ for complex multi-model systems with custom fine-tuning. Ongoing LLM API costs typically run $500-$5,000/month depending on volume. We optimize for cost from day one with caching, batching, and intelligent model routing.' },
