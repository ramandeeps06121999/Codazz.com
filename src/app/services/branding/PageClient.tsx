    ...
    <>
      ...
      <main style={{ background: '#ffffff', color: '#111827', paddingTop: 80 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 480px), 1fr))', gap: 'clamp(24px, 5vw, 80px)', alignItems: 'center' }}>
              ...
              <div>
                <div className="reveal" style={{ display: 'inline-flex', alignItems: 'center', gap: 10, background: 'rgba(17,24,39,0.08)', border: '1px solid rgba(17,24,39,0.2)', borderRadius: 100, padding: '8px 20px', marginBottom: 32 }}>
                  ...
                  <span style={{ fontSize: 11, fontWeight: 700, color: '#111827', letterSpacing: '0.12em', textTransform: 'uppercase' }}>Branding & Identity</span>
                </div>
                <h1 className="reveal reveal-d1" style={{ fontSize: 'clamp(2.8rem,5vw,5rem)', fontWeight: 500, color: '#111827', letterSpacing: '-0.04em', lineHeight: 1.0, margin: '0 0 24px', maxWidth: 700 }}>
                  We Build Brands People <span style={{ color: '#111827' }}>Remember.</span>
                </h1>
        ...
        <section ref={s2} className="section-padding" style={{ borderBottom: '1px solid rgba(0,0,0,0.05)' }}>
          <div className="cb-container">
            <div className="reveal" style={{ marginBottom: 16 }}>
              <span style={{ fontSize: 11, fontWeight: 700, color: '#111827', letterSpacing: '0.12em', textTransform: 'uppercase' }}>What We Do</span>
            </div>
            ...
            <p className="reveal reveal-d2" style={{ fontSize: 16, color: 'rgba(0,0,0,0.45)', maxWidth: 520, margin: '0 0 56px', lineHeight: 1.7 }}>From naming to guidelines — everything you need to build a brand that resonates and converts.</p>
            {/* Service Cards */}
        ...
        <section ref={s3} className="section-padding" style={{ borderBottom: '1px solid rgba(0,0,0,0.05)' }}>
          <div className="cb-container">
            <div className="reveal" style={{ marginBottom: 16 }}>
              <span style={{ fontSize: 11, fontWeight: 700, color: '#111827', letterSpacing: '0.12em', textTransform: 'uppercase' }}>How We Work</span>
            </div>
        ...
        {/* Tools & Platforms */}
        <section ref={s7} style={{ padding: 'clamp(60px, 8vw, 100px) 0', borderBottom: '1px solid rgba(0,0,0,0.05)' }}>
          <div className="cb-container">
            <h2 className="reveal" style={{ fontSize: 'clamp(1.5rem, 3vw, 2.2rem)', fontWeight: 700, color: '#111827', letterSpacing: '-0.03em', marginBottom: 40, textAlign: 'center' }}>
            ...
            <div className="reveal reveal-d1" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 280px), 1fr))', gap: 20 }}>
              {[
                ...
                <div key={g.cat} style={{ padding: 'clamp(24px, 3vw, 36px)', borderRadius: 20, background: 'rgba(0,0,0,0.03)', border: '1px solid rgba(0,0,0,0.06)' }}>
                  <h3 style={{ fontSize: 14, fontWeight: 600, color: '#111827', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 16 }}>{g.cat}</h3>
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
                    {g.tools.map((t) => (
                      <span key={t} style={{ padding: '6px 14px', borderRadius: 100, fontSize: 13, background: 'rgba(0,0,0,0.03)', color: 'rgb(0,0,0)' }}>{t}</span>
                    ))}
                  </div>
                </div>
              ))}
        ...
        <section ref={s8} style={{ padding: 'clamp(60px, 8vw, 100px) 0', borderBottom: '1px solid rgba(0,0,0,0.05)' }}>
          <div className="cb-container">
            <h2 className="reveal" style={{ fontSize: 'clamp(1.5rem, 3vw, 2.2rem)', fontWeight: 700, color: '#111827', letterSpacing: '-0.03em', marginBottom: 16, textAlign: 'center' }}>
              Branding for Every Industry
            </h2>
            <p className="reveal reveal-d1" style={{ fontSize: 15, color: 'rgba(0,0,0,0.4)', textAlign: 'center', maxWidth: 600, margin: '0 auto 40px' }}>
            ...
            <div className="reveal reveal-d2" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 280px), 1fr))', gap: 16 }}>
              {[
                ...
                >
                  <h3 style={{ fontSize: 16, fontWeight: 600, color: '#111827', marginBottom: 8 }}>{ind.industry}</h3>
                  <p style={{ fontSize: 13, color: 'rgba(0,0,0,0.4)', lineHeight: 1.6, margin: 0 }}>{ind.desc}</p>
                </a>
              ))}
            </div>
          </div>
        ...
        {/* Pricing */}
        <section ref={s9} style={{ padding: 'clamp(60px, 8vw, 100px) 0', borderBottom: '1px solid rgba(0,0,0,0.05)' }}>
          <div className="cb-container">
            <h2 className="reveal" style={{ fontSize: 'clamp(1.5rem, 3vw, 2.2rem)', fontWeight: 700, color: '#111827', letterSpacing: '-0.03em', marginBottom: 40, textAlign: 'center' }}>
              Branding Packages
            </h2>
            <div className="reveal reveal-d1" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 280px), 1fr))', gap: 20 }}>
              {[
                ...
                <div key={p.tier} style={{
                  ...
                  background: p.popular ? 'rgba(17,24,39,0.05)' : 'rgba(0,0,0,0.03)',
                  border: `1px solid ${p.popular ? 'rgba(17,24,39,0.2)' : 'rgba(0,0,0,0.06)'}`,
                  position: 'relative',
                }}>
                  {p.popular && <span style={{ position: 'absolute', top: -12, left: '50%', transform: 'translateX(-50%)', padding: '4px 16px', borderRadius: 100, background: '#111827', color: '#fff', fontSize: 11, fontWeight: 700, textTransform: 'uppercase' }}>Most Popular</span>}
                  <h3 style={{ fontSize: 18, fontWeight: 700, color: '#111827', marginBottom: 4 }}>{p.tier}</h3>
                  <div style={{ fontSize: 28, fontWeight: 700, color: '#111827', marginBottom: 8 }}>{p.price}</div>
                  <p style={{ fontSize: 13, color: 'rgba(0,0,0,0.4)', marginBottom: 24, lineHeight: 1.5 }}>{p.desc}</p>
                  <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                    {p.features.map((f) => (
                      <li key={f} style={{ fontSize: 14, color: 'rgb(0,0,0)', padding: '8px 0', borderBottom: '1px solid rgba(0,0,0,0.03)', display: 'flex', alignItems: 'center', gap: 10 }}>
                  ...
                  <a href="/contact" style={{
                    ...
                    background: p.popular ? '#111827' : 'rgba(0,0,0,0.03)',
                    color: '#111827', fontSize: 14, fontWeight: 600, textDecoration: 'none',
        ...
        <section ref={s6} className="section-padding">
          <div className="cb-container" style={{ textAlign: 'center' }}>
            ...
            <h2 className="reveal reveal-d1" style={{ fontSize: 'clamp(2.2rem,4vw,4rem)', fontWeight: 500, letterSpacing: '-0.04em', lineHeight: 1.05, margin: '0 0 24px' }}>
              Ready to Build Your <span style={{ color: '#111827' }}>Brand?</span>
            </h2>
