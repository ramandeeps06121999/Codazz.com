        ...
        <section style={{ padding: 'clamp(100px, 12vw, 140px) 0 clamp(40px, 5vw, 64px)', position: 'relative', overflow: 'hidden' }}>
          ...
          <div className="cb-container">
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginTop: 32, marginBottom: 16 }}>
              ...
              <span className="reveal reveal-d1" style={{ fontSize: 13, color: 'rgba(255,255,255,0.25)' }}>Logistics Client &middot; Los Angeles</span>
            </div>
            ...
            <div className="reveal reveal-d4" style={{
              ...
              <span style={{ fontSize: 15, color: 'rgba(255,255,255,0.25)', fontWeight: 500 }}>
            ...
            <div className="reveal" style={{
              ...
              {metrics.map((m) => (
                <div key={m.label} style={{
                  ...
                  <div style={{ fontSize: 'clamp(28px, 5vw, 40px)', fontWeight: 800, color: '#ffffff', marginBottom: 8 }}>{m.value}</div>
                  <div style={{
        ...
        <section className="section-padding" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          <div className="cb-container" style={{ paddingTop: 'clamp(48px, 6vw, 80px)' }}>
            <div className="reveal" style={{
              ...
              background: 'linear-gradient(135deg, rgba(34,197,94,0.06), rgba(255,255,255,0.015))',
              ...
              <p style={{
                fontSize: 20, color: 'rgba(255,255,255,0.6)', lineHeight: 1.7,
              ...
              <div>
                <p style={{ fontSize: 15, fontWeight: 600, color: '#ffffff', margin: '0 0 4px' }}>VP of Operations</p>
                <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.4)', margin: 0 }}>Leading Los Angeles Logistics Company</p>
              </div>
            </div>
          </div>
        </section>
