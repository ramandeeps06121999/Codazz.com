...
export default function ZoomClonePage() {
  ...
  const techStack = [
    ...
    { cat: 'Real-Time', items: ['WebRTC', 'mediasoup (SFU)', 'WebSocket', 'TURN/STUN'] },
    { cat: 'Backend', items: ['Node.js', 'Go', 'Redis', 'PostgreSQL'] },
    { cat: 'Cloud & DevOps', items: ['AWS', 'Docker', 'Kubernetes', 'Global CDN'] },
  ];

  const timeline = [
    { phase: 'Discovery & Architecture', duration: '2-3 weeks', desc: 'Requirements analysis, media server architecture, UI/UX design, and WebRTC infrastructure planning.' },
    { phase: 'Core Video MVP', duration: '12-14 weeks', desc: 'HD video calls, screen sharing, chat, scheduling, and basic meeting management with up to 100 participants.' },
    { phase: 'Advanced Features', duration: '8-10 weeks', desc: 'Breakout rooms, recording, webinars, virtual backgrounds, whiteboard, and E2E encryption.' },
    { phase: 'Testing & Optimization', duration: '3-4 weeks', desc: 'Load testing, latency optimization, cross-platform QA, security audit, and production deployment.' },
  ];
        ...
        <section ref={heroRef} className="section-padding" style={{ position: 'relative', overflow: 'hidden', minHeight: '90vh', display: 'flex', alignItems: 'center' }}>
          ...
          <div className="cb-container" style={{ position: 'relative', zIndex: 1, textAlign: 'center', maxWidth: 860, margin: '0 auto' }}>
            ...
            <h1 className="reveal" style={{ fontSize: 'clamp(2.6rem, 6vw, 5rem)', fontWeight: 800, lineHeight: 1.1, marginBottom: '1.5rem', letterSpacing: '-0.02em' }}>
              Build a Video App <span style={{ color: '#22c55e' }}>Like Zoom.</span>
            </h1>
            <p className="reveal" style={{ fontSize: '1.2rem', color: 'rgba(255,255,255,0.7)', marginBottom: '2.5rem', lineHeight: 1.7 }}>
              HD video calls, screen sharing, breakout rooms, and enterprise-grade encryption — we build the complete video conferencing platform your business demands.
            </p>
            ...
            <div className="reveal" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(140px, 100%), 1fr))', gap: '1.5rem', maxWidth: 600, margin: '0 auto' }}>
              {[['$70K+', 'Starting Cost'], ['4-9 Mo', 'Development'], ['1000+', 'Participants']].map(([val, label]) => (
        ...
        <section ref={s1} className="section-padding">
          <div className="cb-container">
            <div className="reveal" style={{ textAlign: 'center', marginBottom: '3rem' }}>
              ...
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '1.1rem' }}>Everything you need to launch a world-class video conferencing platform.</p>
            </div>
        ...
        <section ref={s2} className="section-padding">
          <div className="cb-container">
            <div className="reveal" style={{ textAlign: 'center', marginBottom: '3rem' }}>
              ...
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '1.1rem' }}>Low-latency technologies for reliable, real-time video communication.</p>
            </div>
        ...
        <section ref={s4} className="section-padding">
          <div className="cb-container">
            ...
            <div className="reveal" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem', maxWidth: 900, margin: '0 auto' }}>
              {[
                { tier: 'MVP', price: '$70,000 - $100,000', desc: 'Core video conferencing with HD calls, screen sharing, chat, and scheduling. Perfect for validating your concept.', features: ['HD Video Calls', 'Screen Sharing', 'In-Meeting Chat', 'Meeting Scheduling', 'Web & Mobile Apps'] },
                { tier: 'Full Product', price: '$130,000 - $200,000', desc: 'Complete video platform with breakout rooms, recording, webinars, virtual backgrounds, and enterprise security.', features: ['Everything in MVP', 'Breakout Rooms', 'Cloud Recording', 'Webinar Mode', 'Virtual Backgrounds', 'E2E Encryption'] },
              ].map(p => (
                <Card key={p.tier}>
          ...
          <div className="cb-container">
            <div className="reveal" style={{ textAlign: 'center', maxWidth: 700, margin: '0 auto' }}>
              ...
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '1.15rem', marginBottom: '2.5rem', lineHeight: 1.7 }}>
                From one-on-one calls to large-scale webinars — let us build the video conferencing platform that connects your world.
              </p>
