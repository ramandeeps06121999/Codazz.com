...
const tocSections = [
  ...
  { id: 'case-studies', label: 'Real Project Examples', emoji: '📊' },
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 320px', gap: 'clamp(40px, 6vw, 80px)' }}>
              ...
              <article style={{ color: 'rgba(255,255,255,0.75)', fontSize: 17, lineHeight: 1.75 }}>
                ...
                <div className="reveal" style={{ marginBottom: 48 }}>
                  ...
                  <p>
                    In 2026, app development costs range from <strong style={{ color: '#ffffff' }}>$15,000 for a simple MVP</strong> to <strong style={{ color: '#ffffff' }}>$500,000+ for a complex enterprise platform</strong>. But where your project falls depends on specific, measurable factors.
                  </p>
                  <p>
                  ...
                  <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    ...
                    <tbody>
                      <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                        <td style={{ padding: '12px 8px' }}><strong style={{ color: '#b4fd83' }}>Simple MVP</strong></td>
                        <td style={{ padding: '12px 8px' }}>1-2 months</td>
                        <td style={{ padding: '12px 8px', color: '#ffffff' }}>$15,000 - $40,000</td>
                      </tr>
                      <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                        <td style={{ padding: '12px 8px' }}><strong style={{ color: '#b4fd83' }}>Medium App</strong></td>
                        <td style={{ padding: '12px 8px' }}>3-5 months</td>
                        <td style={{ padding: '12px 8px', color: '#ffffff' }}>$40,000 - $100,000</td>
                      </tr>
                      <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                        <td style={{ padding: '12px 8px' }}><strong style={{ color: '#b4fd83' }}>Complex App</strong></td>
                        <td style={{ padding: '12px 8px' }}>6-9 months</td>
                        <td style={{ padding: '12px 8px', color: '#ffffff' }}>$100,000 - $250,000</td>
                      </tr>
                      <tr>
                        <td style={{ padding: '12px 8px' }}><strong style={{ color: '#b4fd83' }}>Enterprise</strong></td>
                        <td style={{ padding: '12px 8px' }}>9-12+ months</td>
                        <td style={{ padding: '12px 8px', color: '#ffffff' }}>$250,000 - $500,000+</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                ...
                {/* Factors Section */}
                <h2 id="factors" className="reveal" style={{
                  fontSize: 'clamp(1.6rem, 3vw, 2rem)', fontWeight: 700, color: '#ffffff',
                  marginTop: 64, marginBottom: 24, letterSpacing: '-0.02em',
                }}>What Really Drives App Development Costs?</h2>
                ...
                <p className="reveal">
                  Not all features are created equal. Here is what common features actually cost:
                </p>
                <div className="reveal" style={{ margin: '24px 0' }}>
                  <ul style={{ paddingLeft: 24, margin: 0 }}>
                    <li style={{ marginBottom: 12 }}><strong style={{ color: '#ffffff' }}>User registration/login:</strong> $2,000 - $6,000</li>
                    <li style={{ marginBottom: 12 }}><strong style={{ color: '#ffffff' }}>Push notifications:</strong> $1,500 - $4,500</li>
                    <li style={{ marginBottom: 12 }}><strong style={{ color: '#ffffff' }}>In-app payments:</strong> $4,000 - $12,000</li>
                    <li style={{ marginBottom: 12 }}><strong style={{ color: '#ffffff' }}>Real-time chat:</strong> $8,000 - $22,500</li>
                    <li style={{ marginBottom: 12 }}><strong style={{ color: '#ffffff' }}>AI recommendation engine:</strong> $20,000 - $60,000</li>
                  </ul>
                </div>

                {/* Platform Section */}
                <h2 id="platforms" className="reveal" style={{
                  fontSize: 'clamp(1.6rem, 3vw, 2rem)', fontWeight: 700, color: '#ffffff',
                  marginTop: 64, marginBottom: 24, letterSpacing: '-0.02em',
                }}>Platform Choice: iOS vs Android vs Both</h2>
                ...
                <div className="reveal" style={{ 
                  ...
                  <div style={{ background: 'rgba(255,255,255,0.03)', padding: 20, borderRadius: 12, border: '1px solid rgba(255,255,255,0.06)' }}>
                    <h4 style={{ color: '#b4fd83', marginBottom: 8 }}>Native (iOS + Android)</h4>
                    <p style={{ fontSize: 14, margin: 0 }}>$40,000 - $200,000 per platform</p>
                    <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.5)', marginTop: 8 }}>Best performance, platform-specific UX</p>
                  </div>
                  <div style={{ background: 'rgba(255,255,255,0.03)', padding: 20, borderRadius: 12, border: '1px solid rgba(255,255,255,0.06)' }}>
                    <h4 style={{ color: '#b4fd83', marginBottom: 8 }}>Cross-Platform</h4>
                    <p style={{ fontSize: 14, margin: 0 }}>$30,000 - $150,000 total</p>
                    <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.5)', marginTop: 8 }}>30-40% savings, Flutter/React Native</p>
                  </div>
                </div>
                ...
                <div className="reveal" style={{ 
                  ...
                  <h3 style={{ fontSize: 24, fontWeight: 700, color: '#ffffff', marginBottom: 16 }}>
                    Get Your Custom App Development Quote
                  </h3>
                  <p style={{ color: 'rgba(255,255,255,0.7)', marginBottom: 24, maxWidth: 500, marginLeft: 'auto', marginRight: 'auto' }}>
                    Every app is unique. Let us analyze your requirements and provide a detailed cost breakdown.
                  </p>
