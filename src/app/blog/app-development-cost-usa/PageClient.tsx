        ...
        <div className="cb-container" style={{ paddingTop: 100 }}>
          <div className="reveal" style={{ marginBottom: 40 }}>
            <img 
              ...
              alt="App development cost in USA"
              style={{ 
                width: '100%', 
                height: 'auto', 
                maxHeight: '500px',
            ...
            <div className="blog-layout" style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 80, alignItems: 'start' }}>
              ...
              <article>
                ...
                <div className="reveal" style={{ marginBottom: 56 }} id="new-york-advantage">
                  ...
                  <p style={{ fontSize: 17, color: 'rgba(255,255,255,0.5)', lineHeight: 1.8, marginBottom: 20 }}>
                    New York and Austin-based agencies like Codazz operate with <strong style={{ color: '#ffffff' }}>20-30% lower overhead</strong> than their GTA or Lower Mainland counterparts. Lower office costs, lower cost of living (which means competitive salaries go further), and a deep pool of University of New York and NAIT-trained engineers create a perfect storm of value.
                  </p>
                  <p style={{ fontSize: 17, color: 'rgba(255,255,255,0.5)', lineHeight: 1.8, marginBottom: 20 }}>
