              ...
              <article>
                ...
                <div className="reveal" style={{ marginBottom: 56 }} id="definition">
                    ...
                    <div style={{
                      ...
                      borderRadius: 16, padding: 24, marginBottom: 16,
                        ...
                        <p style={{ fontSize: 16, color: '#111827', margin: '0 0 8px', fontWeight: 600 }}>B2C SaaS (Business-to-Consumer):</p>
                ...
                <div className="reveal" style={{ marginBottom: 56 }} id="features">
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(280px, 100%), 1fr))', gap: 20 }}>
                        <div style={{ background: 'rgba(0,0,0,0.015)', border: '1px solid rgba(0,0,0,0.06)', borderRadius: 20, padding: 24 }}>
                            <div style={{ width: 40, height: 40, borderRadius: 12, background: 'rgba(0,0,0,0.03)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 20, marginBottom: 16 }}>📊</div>
                            <h3 style={{ fontSize: 18, color: '#111827', fontWeight: 700, margin: '0 0 8px' }}>1. Tiered Pricing</h3>
                            <p style={{ fontSize: 14, color: 'rgba(0,0,0,0.4)', margin: 0, lineHeight: 1.6 }}>The gold standard. Offer Basic, Pro, and Enterprise tiers. This captures small businesses early and upsells them.</p>
                        </div>
                        <div style={{ background: 'rgba(0,0,0,0.015)', border: '1px solid rgba(0,0,0,0.06)', borderRadius: 20, padding: 24 }}>
                           <div style={{ width: 40, height: 40, borderRadius: 12, background: 'rgba(0,0,0,0.03)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 20, marginBottom: 16 }}>⚡</div>
                            <h3 style={{ fontSize: 18, color: '#111827', fontWeight: 700, margin: '0 0 8px' }}>2. Usage-Based</h3>
                            <p style={{ fontSize: 14, color: 'rgba(0,0,0,0.4)', margin: 0, lineHeight: 1.6 }}>Charge based on usage (e.g., APIs, AI tokens, emails sent). This model has exploded in popularity in 2026.</p>
                        </div>
                        <div style={{ background: 'rgba(0,0,0,0.015)', border: '1px solid rgba(0,0,0,0.06)', borderRadius: 20, padding: 24 }}>
                            <div style={{ width: 40, height: 40, borderRadius: 12, background: 'rgba(0,0,0,0.03)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 20, marginBottom: 16 }}>🎁</div>
                            <h3 style={{ fontSize: 18, color: '#111827', fontWeight: 700, margin: '0 0 8px' }}>3. Freemium</h3>
                            <p style={{ fontSize: 14, color: 'rgba(0,0,0,0.4)', margin: 0, lineHeight: 1.6 }}>Offer a limited version for free to acquire users rapidly, then gate the most valuable features behind a paywall.</p>
                        </div>
                        <div style={{ background: 'rgba(0,0,0,0.015)', border: '1px solid rgba(0,0,0,0.06)', borderRadius: 20, padding: 24 }}>
                            <div style={{ width: 40, height: 40, borderRadius: 12, background: 'rgba(0,0,0,0.03)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 20, marginBottom: 16 }}>⏱️</div>
                            <h3 style={{ fontSize: 18, color: '#111827', fontWeight: 700, margin: '0 0 8px' }}>4. Annual Contracts</h3>
                            <p style={{ fontSize: 14, color: 'rgba(0,0,0,0.4)', margin: 0, lineHeight: 1.6 }}>Securing upfront cash flow at a discount to fund your marketing and development bandwidth immediately.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="reveal" style={{ marginBottom: 56 }} id="stack">
                    ...
                    <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 24px', display: 'flex', flexDirection: 'column', gap: 16 }}>
                        <li style={{ display: 'flex', gap: 16 }}>
                            ...
                            <div>
                                <strong style={{ color: '#111827', display: 'block', marginBottom: 4 }}>Performance</strong>
                                <span style={{ color: 'rgba(0,0,0,0.5)', fontSize: 15, lineHeight: 1.6 }}>A Next.js and Node.js application will load instantly and handle thousands of concurrent users. No-code buckles under traffic.</span>
                            </div>
                        </li>
                        <li style={{ display: 'flex', gap: 16 }}>
                            <div style={{ width: 24, height: 24, borderRadius: '50%', background: 'rgba(17,24,39,0.1)', color: '#111827', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: 4 }}>
                            ...
                            <div>
                                <strong style={{ color: '#111827', display: 'block', marginBottom: 4 }}>Ownership</strong>
                                <span style={{ color: 'rgba(0,0,0,0.5)', fontSize: 15, lineHeight: 1.6 }}>You actually own the intellectual property. You don't lease your core product from a third-party builder.</span>
                            </div>
                        </li>
                        <li style={{ display: 'flex', gap: 16 }}>
                            <div style={{ width: 24, height: 24, borderRadius: '50%', background: 'rgba(17,24,39,0.1)', color: '#111827', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: 4 }}>
                            ...
                            <div>
                                <strong style={{ color: '#111827', display: 'block', marginBottom: 4 }}>Security</strong>
                                <span style={{ color: 'rgba(0,0,0,0.5)', fontSize: 15, lineHeight: 1.6 }}>B2B clients demand rigorous security compliance (SOC2) that DIY builders cannot guarantee.</span>
                            </div>
                        </li>
                    </ul>
                    <p style={{ fontSize: 14, color: 'rgba(0,0,0,0.4)', fontStyle: 'italic' }}>
