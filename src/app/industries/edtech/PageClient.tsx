        ...
        <section ref={heroRef} className="section-padding" style={{ position: 'relative', overflow: 'hidden', minHeight: '90vh', display: 'flex', alignItems: 'center' }}>
          ...
          <div className="cb-container" style={{ position: 'relative', zIndex: 1, textAlign: 'center', maxWidth: 860, margin: '0 auto' }}>
            ...
            <h1 className="reveal" style={{ fontSize: 'clamp(2.6rem, 6vw, 5rem)', fontWeight: 800, lineHeight: 1.1, marginBottom: '1.5rem', letterSpacing: '-0.02em' }}>
              We Build EdTech That <span style={{ color: '#111827' }}>Inspires Learning.</span>
            </h1>
        ...
        <section ref={s1} className="section-padding">
          <div className="cb-container">
            <div className="reveal" style={{ textAlign: 'center', marginBottom: '3rem' }}>
              ...
              <p style={{ color: 'rgb(0,0,0)', fontSize: '1.1rem' }}>Engagement, scale, and personalisation — the three pillars of effective EdTech.</p>
            </div>
        ...
        <section ref={s2} className="section-padding">
          <div className="cb-container">
            <div className="reveal" style={{ textAlign: 'center', marginBottom: '3rem' }}>
              ...
              <p style={{ color: 'rgb(0,0,0)', fontSize: '1.1rem' }}>Learning experiences built for outcomes, not just completion.</p>
            </div>
          ...
          <div className="cb-container">
            <div className="reveal" style={{ border: '1px solid rgba(17,24,39,0.15)', borderRadius: 32, background: 'rgba(17,24,39,0.03)', padding: 'clamp(1.5rem, 4vw, 3rem)', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(400px, 100%), 1fr))', gap: 'clamp(1.5rem, 4vw, 3rem)', alignItems: 'center' }}>
              <div>
                ...
                <div style={{ fontSize: '1.1rem', fontWeight: 700, color: '#111827', marginBottom: '0.5rem' }}>LearnPath</div>
                ...
                <p style={{ color: 'rgb(0,0,0)', lineHeight: 1.7 }}>We rebuilt their platform with an AI-powered adaptive engine, gamified progress tracking, and a native mobile app that works offline — tripling engagement within 60 days.</p>
              </div>
              <div>
        ...
        <section ref={s4} className="section-padding">
          <div className="cb-container">
            <div className="reveal" style={{ textAlign: 'center', marginBottom: '3rem' }}>
              ...
              <p style={{ color: 'rgb(0,0,0)', fontSize: '1.1rem' }}>Modern EdTech infrastructure for the next generation of learners.</p>
            </div>
        ...
        <section ref={s5} className="section-padding">
          <div className="cb-container">
            <div className="reveal" style={{ textAlign: 'center', marginBottom: '3rem' }}>
              ...
              <p style={{ color: 'rgb(0,0,0)', fontSize: '1.1rem' }}>We build for learners first — then scale for millions.</p>
            </div>
            <div className="reveal" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem' }}>
              {[
          ...
          <div className="cb-container">
            <div className="reveal" style={{ textAlign: 'center', maxWidth: 700, margin: '0 auto' }}>
              <h2 style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)', fontWeight: 800, lineHeight: 1.15, marginBottom: '1.5rem' }}>
                Build Your <span style={{ color: '#111827' }}>EdTech Platform.</span>
              </h2>
