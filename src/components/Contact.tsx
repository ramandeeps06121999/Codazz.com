        ...
        <div className="contact-inner contact-grid" style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{ textAlign: 'left' }}>
            ...
            <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
              ...
              <Link href="/services/mobile-app-development" style={{ display: 'inline-flex', alignItems: 'center', gap: 10, height: 52, padding: '0 28px', borderRadius: 100, border: '1px solid rgba(0,0,0,0.1)', color: '#111827', fontSize: 14, fontWeight: 500, textDecoration: 'none', transition: '0.3s' }}
          ...
          {/* Right — form */}
          <div style={{ background: 'rgba(0,0,0,0.015)', border: '1px solid rgba(0,0,0,0.06)', borderRadius: 24, padding: 'clamp(20px, 4vw, 40px)' }}>
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                <div>
                  <label htmlFor="contact-name" style={{ display: 'block', fontSize: 12, fontWeight: 600, color: 'rgba(0,0,0,0.5)', marginBottom: 8 }}>Name *</label>
                  <input
                    id="contact-name"
                    required
                    aria-required="true"
                    ...
                    style={{ width: '100%', padding: '14px 18px', borderRadius: 12, border: '1px solid rgba(0,0,0,0.08)', background: 'rgba(0,0,0,0.02)', color: '#111827', fontSize: 16, outline: 'none', boxSizing: 'border-box' }}
                  />
                </div>
                <div>
                  <label htmlFor="contact-email" style={{ display: 'block', fontSize: 12, fontWeight: 600, color: 'rgba(0,0,0,0.5)', marginBottom: 8 }}>Email *</label>
                  <input
                    id="contact-email"
                    required
                    aria-required="true"
                ...
                <div>
                  <label htmlFor="contact-company" style={{ display: 'block', fontSize: 12, fontWeight: 600, color: 'rgba(0,0,0,0.5)', marginBottom: 8 }}>Company</label>
                  <input
                    id="contact-company"
                    type="text"
                ...
                <div>
                  <label htmlFor="contact-message" style={{ display: 'block', fontSize: 12, fontWeight: 600, color: 'rgba(0,0,0,0.5)', marginBottom: 8 }}>Project details</label>
                  <textarea
                    id="contact-message"
                    rows={4}
                    ...
                    style={{ width: '100%', padding: '14px 18px', borderRadius: 12, border: '1px solid rgba(0,0,0,0.08)', background: 'rgba(0,0,0,0.02)', color: '#111827', fontSize: 16, outline: 'none', resize: 'vertical', boxSizing: 'border-box' }}
                  />
                </div>
                <button
                  type="submit"
