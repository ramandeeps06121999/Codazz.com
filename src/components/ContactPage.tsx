...
export default function ContactPage() {
  ...
  const sel: React.CSSProperties = { ...inp, appearance: 'none' as const, backgroundImage: `url("data:image/svg+xml,%3Csvg width='12' height='7' viewBox='0 0 12 7' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M1 1L6 6L11 1' stroke='rgb(0,0,0)' stroke-width='1.5' stroke-linecap='round'/%3E%3C/svg%3E")`, backgroundRepeat: 'no-repeat', backgroundPosition: 'right 18px center' };
  const lbl: React.CSSProperties = { display: 'block', fontSize: 11, fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase' as const, color: 'rgb(0,0,0)', marginBottom: 8 };
  const fi = (e: React.FocusEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => { e.currentTarget.style.borderColor = 'rgba(17,24,39,0.5)'; e.currentTarget.style.boxShadow = '0 0 0 3px rgba(17,24,39,0.08)'; };
    ...
    <div style={{ background: '#ffffff', color: '#111827', paddingTop: 80 }}>
      ...
      <section ref={heroRef} style={{ position: 'relative', overflow: 'hidden', padding: 'clamp(60px, 10vw, 100px) 0 clamp(60px, 10vw, 120px)', borderBottom: '1px solid rgba(0,0,0,0.06)', textAlign: 'center' }}>
        ...
        <div className="cb-container" style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 28 }}>
          {/* Live badge */}
          <div className="reveal" style={{ display: 'inline-flex', alignItems: 'center', gap: 10, background: 'rgba(17,24,39,0.08)', border: '1px solid rgba(17,24,39,0.2)', borderRadius: 100, padding: '8px 20px' }}>
            <div style={{ width: 6, height: 6, borderRadius: '50%', background: '#111827', boxShadow: '0 0 8px #111827', animation: 'pulse-glow 2s infinite' }} />
            <span style={{ fontSize: 11, fontWeight: 700, color: '#111827', letterSpacing: '0.12em', textTransform: 'uppercase' as const }}>Available for New Projects</span>
          </div>
          ...
          <h1 className="reveal reveal-d1" style={{ fontSize: 'clamp(3rem,8vw,8rem)', fontWeight: 500, color: '#111827', letterSpacing: '-0.05em', lineHeight: 0.95, margin: 0, maxWidth: 1000 }}>
            Let&apos;s Build Something<br /><span style={{ color: '#111827' }}>Extraordinary.</span>
          </h1>

          <p className="reveal reveal-d2" style={{ fontSize: 'clamp(1rem,1.8vw,1.2rem)', color: 'rgb(0,0,0)', maxWidth: 540, lineHeight: 1.75, margin: 0 }}>
          ...
          <div className="reveal reveal-d3" style={{ display: 'flex', gap: 16, flexWrap: 'wrap', justifyContent: 'center' }}>
            <a href="#contact-form" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 12, height: 56, padding: '0 clamp(24px, 4vw, 40px)', borderRadius: 100, background: '#111827', color: '#fff', fontSize: 15, fontWeight: 700, textDecoration: 'none', transition: '0.3s' }}
            ...
            <a href="https://calendly.com/townmedialabs/30min" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 10, height: 56, padding: '0 clamp(24px, 4vw, 40px)', borderRadius: 100, border: '1px solid rgba(0,0,0,0.08)', color: '#111827', fontSize: 15, fontWeight: 500, textDecoration: 'none', transition: '0.3s' }}
          ...
          <div className="reveal reveal-d4" style={{ display: 'flex', gap: 32, flexWrap: 'wrap', paddingTop: 44, borderTop: '1px solid rgba(0,0,0,0.06)', justifyContent: 'center', width: '100%', marginTop: 8 }}>
            {TRUST.map(t => (
              <div key={t.label} style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
                ...
                <span style={{ fontSize: 13, color: 'rgb(0,0,0)', fontWeight: 500, whiteSpace: 'nowrap' as const }}>{t.label}</span>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="reveal reveal-d1 cp-engage-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(280px, 100%), 1fr))', gap: 20 }}>
            {ENGAGEMENT.map(o => (
              <a key={o.num} href={'href' in o && o.href ? o.href : '#contact-form'} {...('href' in o && o.href ? { target: '_blank', rel: 'noopener noreferrer' } : {})}
                ...
                onMouseEnter={e => { e.currentTarget.style.borderColor = 'rgba(17,24,39,0.28)'; e.currentTarget.style.background = 'rgba(17,24,39,0.04)'; e.currentTarget.style.transform = 'translateY(-6px)'; e.currentTarget.style.boxShadow = '0 32px 64px rgba(0,0,0,0.06)'; }}
                ...
                <span style={{ fontSize: 10, fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase' as const, color: '#111827', background: 'rgba(17,24,39,0.1)', padding: '5px 14px', borderRadius: 100, display: 'inline-block', alignSelf: 'flex-start' }}>{o.tag}</span>
                <div>
                ...
                <div style={{ marginTop: 'auto', display: 'inline-flex', alignItems: 'center', gap: 8, color: '#111827', fontSize: 13, fontWeight: 700 }}>{o.cta}</div>
              </a>
            ))}
          </div>
        </div>
        ...
        <div className="cb-container">
          <div className="reveal cp-contact-form-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1.4fr', gap: 'clamp(32px, 6vw, 80px)', alignItems: 'start' }}>
            ...
            <div>
              ...
              <p style={{ fontSize: 16, color: 'rgb(0,0,0)', lineHeight: 1.75, marginBottom: 48, maxWidth: 380 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 24, marginBottom: 48 }}>
                {[
                  ...
                  <div key={item.label} style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                    <div style={{ width: 44, height: 44, borderRadius: 12, background: 'rgba(17,24,39,0.07)', border: '1px solid rgba(17,24,39,0.13)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                    ...
                    <div>
                      ...
                      {item.href
                        ? <a href={item.href} style={{ fontSize: 14, color: '#111827', fontWeight: 500, textDecoration: 'none' }}>{item.value}</a>
              ...
              {/* NDA note */}
              <div style={{ padding: '20px 22px', background: 'rgba(17,24,39,0.04)', border: '1px solid rgba(17,24,39,0.1)', borderRadius: 16, display: 'flex', alignItems: 'flex-start', gap: 14 }}>
                <span style={{ fontSize: 20, flexShrink: 0, marginTop: 2 }}>🔒</span>
                <span style={{ fontSize: 13, color: 'rgb(0,0,0)', lineHeight: 1.65 }}>All enquiries are protected by NDA. Your ideas stay confidential from the very first conversation.</span>
              </div>
            </div>
            ...
            <div style={{ background: 'rgba(0,0,0,0.015)', border: '1px solid rgba(0,0,0,0.06)', borderRadius: 36, padding: 'clamp(20px, 4vw, 52px) clamp(20px, 4vw, 44px)' }}>
              {submitted ? (
                <div style={{ textAlign: 'center', padding: '48px 0' }}>
                  <div style={{ width: 72, height: 72, borderRadius: '50%', background: 'rgba(17,24,39,0.1)', border: '1px solid rgba(17,24,39,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 24px' }}>
                    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#111827" strokeWidth="2"><path d="M20 6L9 17l-5-5" /></svg>
                  </div>
                  <h3 style={{ fontSize: 28, fontWeight: 600, color: '#111827', letterSpacing: '-0.03em', marginBottom: 12 }}>We&apos;ve Got It!</h3>
                  <p style={{ fontSize: 15, color: 'rgb(0,0,0)', lineHeight: 1.7, maxWidth: 360, margin: '0 auto 32px' }}>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                  ...
                  {error && <div id="cp-form-error" role="alert" style={{ color: '#111827', fontSize: 13, fontWeight: 500, background: 'rgba(17,24,39,0.1)', border: '1px solid rgba(17,24,39,0.2)', padding: '12px 16px', borderRadius: 12, marginTop: 4 }}>{error}</div>}

                  <button type="submit" disabled={isLoading} style={{ marginTop: 4, height: 60, borderRadius: 100, border: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12, background: isLoading ? 'rgba(17,24,39,0.5)' : '#111827', color: '#fff', fontSize: 15, fontWeight: 700, cursor: isLoading ? 'not-allowed' : 'pointer', transition: '0.3s', fontFamily: 'inherit' }}
                    onMouseEnter={e => { if(!isLoading){ e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 16px 40px rgba(17,24,39,0.35)'; } }}
        ...
        <div className="cb-container" style={{ position: 'relative', zIndex: 1 }}>
          <div className="reveal" style={{ textAlign: 'center', marginBottom: 56 }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 10, background: 'rgba(6,182,212,0.08)', border: '1px solid rgba(6,182,212,0.2)', borderRadius: 100, padding: '8px 20px', marginBottom: 24 }}>
              ...
              <span style={{ fontSize: 11, fontWeight: 700, color: '#374151', letterSpacing: '0.12em', textTransform: 'uppercase' as const }}>99% Virtual Meetings</span>
            </div>
            <h2 style={{ fontSize: 'clamp(2.2rem,4vw,3.8rem)', fontWeight: 500, color: '#111827', letterSpacing: '-0.04em', lineHeight: 1.08, margin: '0 0 20px' }}>
              Headquarters in Two Cities.<br /><span style={{ color: '#374151' }}>Talent From Everywhere.</span>
            </h2>
          ...
          <div className="reveal reveal-d2 cp-offices-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(280px, 100%), 1fr))', gap: 16, maxWidth: 640, margin: '0 auto' }}>
            {OFFICES.map(o => (
              <div key={o.city}
                ...
                onMouseEnter={e => { e.currentTarget.style.background = 'rgba(17,24,39,0.04)'; e.currentTarget.style.borderColor = 'rgba(17,24,39,0.2)'; }}
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, marginBottom: 8 }}>
                  ...
                  <span style={{ fontSize: 9, fontWeight: 700, color: '#111827', background: 'rgba(17,24,39,0.1)', padding: '3px 8px', borderRadius: 100, letterSpacing: '0.08em' }}>HQ</span>
                </div>
      ...
      <section ref={faqRef} style={{ padding: 'clamp(48px, 8vw, 100px) 0', borderBottom: '1px solid rgba(0,0,0,0.06)' }}>
        <div className="cb-container" style={{ maxWidth: 860 }}>
          ...
          <div className="reveal reveal-d1" style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            {FAQS.map((faq, i) => (
              <div key={i} style={{ background: openFaq === i ? 'rgba(17,24,39,0.04)' : 'rgba(0,0,0,0.015)', border: `1px solid ${openFaq === i ? 'rgba(17,24,39,0.2)' : 'rgba(0,0,0,0.06)'}`, borderRadius: 20, overflow: 'hidden', transition: 'border-color 0.3s, background 0.3s' }}>
      ...
      <section style={{ padding: 'clamp(60px, 10vw, 120px) 0', position: 'relative', overflow: 'hidden', textAlign: 'center' }}>
        <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', width: 700, height: 400, background: 'radial-gradient(ellipse,rgba(17,24,39,0.08) 0%,transparent 70%)', filter: 'blur(60px)', pointerEvents: 'none' }} />
        <div className="cb-container" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <h2 style={{ fontSize: 'clamp(2.5rem,5vw,5rem)', fontWeight: 500, color: '#111827', letterSpacing: '-0.04em', lineHeight: 1.0, margin: '0 0 28px' }}>
            Your Next Big Thing<br /><span style={{ color: '#111827' }}>Starts Here.</span>
          </h2>
      ...
      <style>{`
        @keyframes pulse-glow {
          0%,100%{opacity:1;box-shadow:0 0 0 0 rgba(17,24,39,0.5);}
          50%{opacity:.7;box-shadow:0 0 0 8px rgba(17,24,39,0);}
        }
        @keyframes spin-slow {
