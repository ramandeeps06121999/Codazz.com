  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl">
        ...
        >
          <Badge className="mb-4 border-gray-200 bg-gray-100 text-gray-900" variant="secondary">
            <Grid className="mr-1 h-3 w-3" />
            Gallery
          </Badge>
          <h2
            id="gallery-heading"
            className="mb-4 text-4xl font-bold tracking-tight text-gray-900"
          >
            Our Portfolio
          </h2>
        ...
        >
          {categories.map((category) => (
            <Button
              ...
              className={filter === category ? "bg-gray-900 text-white hover:bg-gray-900" : "border-gray-200 text-gray-600 hover:border-gray-300 hover:bg-gray-100"}
            >
              {category}
            </Button>
          ))}
        ...
        >
          <AnimatePresence mode="popLayout">
            {filteredImages.map((image, index) => (
              ...
              >
                <Card
                  className="group relative cursor-pointer overflow-hidden rounded-2xl border-gray-100 transition-all hover:border-gray-300 hover:shadow-xl hover:shadow-gray-800/5"
                ...
                >
                  <div className="relative aspect-square overflow-hidden">
                    ...
                    >
                      ...
                      <Badge variant="secondary" className="bg-white/20 text-white">{image.category}</Badge>
                    </motion.div>
                  </div>
                </Card>
              </motion.div>
